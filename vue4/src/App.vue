...
<template>
  <section class="container mx-auto">
    ...
    <section class="flex space-x-10">
      <div class="w-1/3 h-16" :style="bgOrange">hello 1</div>
      <div class="w-1/3 h-16" :style="bgIndigo">hello 2</div>
      <div class="w-1/3 h-16" :style="bgGreen">hello 3</div>
    </section>

    <section class="mt-10">
      <div class="h-16 flex items-center justify-center text-white"  >Hello</div>
